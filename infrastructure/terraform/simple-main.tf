# Simplified AWS Infrastructure for Whitepine Personal Development Project
# This is a minimal setup for personal development use
...
# Local values
locals {
  name_prefix = "whitepine-${var.environment}"
...
# ECS Service (simplified - public subnets only)
...
resource "aws_secretsmanager_secret" "mongodb_uri" {
  ...
  recovery_window_in_days = 0  # No recovery window for personal use
...
# S3 Bucket for Frontend (simplified)
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  price_class = "PriceClass_100"  # Cheapest option for personal use
